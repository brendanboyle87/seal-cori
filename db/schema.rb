...
ActiveRecord::Schema.define(version: 20151116042146) do
  ...
  create_table "unsealable_crimes", force: :cascade do |t|
    t.string "offense_name", null: false
  end

  add_index "unsealable_crimes", ["offense_name"], name: "index_unsealable_crimes_on_offense_name", unique: true, using: :btree
